    ...
    <>
      <div className="publications" style={{ backgroundColor: '#817d7d27' }}>
        ...
        <div className="all_links">
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://bmcpediatr.biomedcentral.com/articles/10.1186/s12887-020-1969-6' target='_blank' rel="noopener noreferrer"> Validity of low-cost measures for global surveillance of physical activity in pre-school children: The SUNRISE validation study.</a></h2>
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://link.springer.com/article/10.1007/s12098-021-03895-2' target='_blank' rel="noopener noreferrer"> Prevalence of Physical Activity, Screen Time, and Sleep, and Associations with Adiposity and Motor
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://journals.lww.com/acsm-msse/Abstract/9000/Levels_and_Correlates_of_Objectively_Measured.95866.aspx' target='_blank' rel="noopener noreferrer"> Levels and Correlates of Objectively Measured Sedentary Behaviour in Young Children: SUNRISE Study
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://bmcpediatr.biomedcentral.com/articles/10.1186/s12887-020-1969-6' target='_blank' rel="noopener noreferrer"> The impact of covid‐19 on preschool‐aged children’s movement behaviors in Hong Kong: A longitudinal analysis of accelerometer‐measured data.</a></h2>
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://pilotfeasibilitystudies.biomedcentral.com/articles/10.1186/s40814-021-00912-1' target='_blank' rel="noopener noreferrer"> International study of 24-h movement behaviors of early years (SUNRISE): a pilot study from Bangladesh.
            </a></h2>
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://journals.assaf.org.za/index.php/sajsm/article/view/10864' target='_blank' rel="noopener noreferrer"> 24 hour movement behaviours and the health and development of pre-school children from Zimbabwean
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://bmcpublichealth.biomedcentral.com/articles/10.1186/s12889-021-10852-3' target='_blank' rel="noopener noreferrer"> Global effect of COVID-19 pandemic on physical activity, sedentary behaviour and sleep among 3- to
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/> Relationship between adherence to WHO “24-Hour Movement Guidelines for the Early Years” and motor skills or cognitive function in preschool children: SUNRISE pilot study.</h2>
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://bmcpediatr.biomedcentral.com/articles/10.1186/s12887-020-1969-6' target='_blank' rel="noopener noreferrer"> Proportion of kindergarten
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://journals.assaf.org.za/index.php/sajsm/article/view/8415' target='_blank' rel="noopener noreferrer"> Understanding
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/><a style={{ textDecoration: 'none' }} href='https://www.mdpi.com/1660-4601/17/22/8491' target='_blank' rel="noopener noreferrer"> International Study of Movement Behaviors in the Early Years (SUNRISE): Results from SUNRISE
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/> SUNRISE International Surveillance Study of Movement Behaviours in the Early Years: Preliminary
          ...
          <div className='pub_item'>
            <h2><ArticleIcon style={{color:'#96353e'}}/> SUNRISE International Surveillance Study of Movement Behaviours in the Early Years: 24-hour movement behaviour
